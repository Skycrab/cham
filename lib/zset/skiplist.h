...
unsigned long slDeleteByRank(skiplist *sl, unsigned int start, unsigned int end, void* ud);
...
skiplistNode *getNextNode(skiplistNode *node, int reverse);

extern void delCb(void* ud, slobj *o);
